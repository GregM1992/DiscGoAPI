...
public class DiscGoAPIDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BaggedDisc>().HasData(new BaggedDisc[] {
            new BaggedDisc { Id = 2, DiscId = "hdye73-hfuye=3jdfuj", BagId = 1, Aces = 2, Birdies = 3, Brand = "axiom", Category = "putter", Color = "#343403", Fade = "3", Glide = "3", Name = "roc", Speed = "3", Stability = "over-stable", Turn = "3", Favorite = true, Background_color="#34532", Pic = "fakeUrl", LongestThrow = 375 },
        });
